                        ...
                        <v-window v-model="tab" class="w-100 py-3">
                            <v-window-item value="0">
                                ...
                                <v-row>
                                    ...
                                    <v-col cols="12" sm="3">
                                        <v-text-field :label="'Цена за ' + ((order.price_type || 0) === 0 ? 'единицу груза' : 'транспорт')"
                                                      type="number"
                                                      v-model="order.price"
                                    ...
                                    <v-col cols="12" sm="3">
                                        <v-text-field :label="'Цена за ' + ((order.price_type || 0) === 0 ? 'единицу груза' : 'транспорт') + ' с НДС'"
                                                      type="number"
                                    ...
                                    <v-col cols="12" sm="3">
                                        <v-autocomplete label="Тип оплаты"
                                                        :disable="order.status === 'COMPLETED'"
                                                        v-model="order.orders_payments_type"
                                                        density="compact"
                                                        hide-details
                                                        item-title="title"
                                                        item-value="id"
                                    ...
                                    <v-col cols="12" sm="3">
                                        <v-text-field label="Оплата простоя, руб/день"
                                                      type="number"
